...
PlayerFramework.TtmlParser=PlayerFramework.Object.extend({init:function(a){this._super();this.mergeOptions(a,{xmlNamespace:"http://www.w3.org/XML/1998/namespace",ttmlNamespace:"http://www.w3.org/ns/ttml",ttmlStyleNamespace:"http://www.w3.org/ns/ttml#styling",ttmlMetaNamespace:"http://www.w3.org/ns/ttml#metadata",smpteNamespace:"https://web.archive.org/web/20200522155108/http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt",trackIdPrefix:"",mediaFrameRate:30,mediaFrameRateMultiplier:1,mediaSubFrameRate:1,mediaTickRate:1E3,mediaStart:0,mediaDuration:Math.pow(2,
53),clocktime:/^(\d{2,}):(\d{2}):(\d{2})((?:\.\d{1,})|:(\d{2,}(?:\.\d{1,})?))?$/,offsettime:/^(\d+(\.\d+)?)(ms|[hmsft])$/});this.regions=this.body=this.head=this.layout=this.root=null;this.usingDefaultRegion=!0;this.TTMLEvents=[];this.Descriptions=[];this.Navigation=null;this.StyleSetCache={};this.styleSetId=0;this.ImageCache={};this.rightMostInLevel=[];this.nodeType={ELEMENT_NODE:1,ATTRIBUTE_NODE:2,TEXT_NODE:3,CDATA_SECTION_NODE:4,ENTITY_REFERENCE_NODE:5,ENTITY_NODE:6,PROCESSING_INSTRUCTION_NODE:7,
COMMENT_NODE:8,DOCUMENT_NODE:9,DOCUMENT_TYPE_NODE:10,DOCUMENT_FRAGMENT_NODE:11,NOTATION_NODE:12}},parseTtml:function(a){this.xmlDoc="string"==typeof a?this.parseXml(a):a;if(this.root=this.getElementsByTagNameNS(this.xmlDoc,this.options.ttmlNamespace,"tt")[0])this.body=this.getElementsByTagNameNS(this.root,this.options.ttmlNamespace,"body")[0]||null,this.layout=(this.head=this.getElementsByTagNameNS(this.root,this.options.ttmlNamespace,"head")[0]||null)?this.getElementsByTagNameNS(this.root,this.options.ttmlNamespace,
...
c.push(d)}else PlayerFramework.forEach(this.regions,PlayerFramework.proxy(this,function(d){var e=this.attrNS(d,"id",this.options.xmlNamespace);if(d=this.translateMarkup(d,a)){(e=this.prune(b,e,a))&&d.appendChild(e);var e="whenActive"!=d.getAttribute("data-showBackground"),i=d.innerHTML.replace(/\s/g,"");e&&""!=i&&c.push(d)}}));return c},applyTiming:function(a,b,c){var d,e,f;this.hasAttr(a,"begin")?(d=this.getTime(this.getAttr(a,"begin"))+0.01,e=b.first+d):e=b.first;!this.hasAttr(a,"dur")&&!this.hasAttr(a,
"end")?c&&(e<=b.second?(Math.max(0,b.second-e),f=b.second):f=0):this.hasAttr(a,"dur")&&this.hasAttr(a,"end")?(d=this.getTime(this.getAttr(a,"dur")),c=this.getTime(this.getAttr(a,"end")),c=Math.min(e+d,b.first+c),f=Math.min(c,b.second)):this.hasAttr(a,"end")?(c=this.getTime(this.getAttr(a,"end")),f=Math.min(b.first+c,b.second)):(d=this.getTime(this.getAttr(a,"dur")),f=Math.min(e+d,b.second));f<e&&(f=e);a.setAttribute("data-time-start",e);a.setAttribute("data-time-end",f);PlayerFramework.first(this.TTMLEvents,
function(a){return a.tick==e})||this.TTMLEvents.push({tick:e,elementScope:a});PlayerFramework.first(this.TTMLEvents,function(a){return a.tick==f})||this.TTMLEvents.push({tick:f,elementScope:a});this.TTMLEvents.sort(function(a,b){return a.tick-b.tick});if(this.attrNS(a,"role",this.options.ttmlMetaNamespace)&&(b=this.attrNS(a,"audio","https://web.archive.org/web/20200522155108/http://www.microsoft.com/enable#media")))this.Descriptions.push({start:e,end:f,id:"description"+(this.Descriptions.length+1),uri:b,caption:""}),this.Descriptions.sort(function(a,
b){return a.start-b.start});var h=e,i=this.getAttr(a,"timeContainer");PlayerFramework.forEach(this.children(a),PlayerFramework.proxy(this,function(a){if(i!="seq")this.applyTiming(a,{first:e,second:f},true);else{this.applyTiming(a,{first:h,second:f},false);h=new Number(this.getAttr(a,"data-time-end"))}}))},getTime:function(a){var b;b=this.options.clocktime.exec(a);a=this.options.offsettime.exec(a);if(null!=b){var a=new Number(b[1]),c=new Number(b[2]),d=new Number(b[3]),e=0;isNaN(b[4])||(d+=new Number(b[4]));
...
case "http://www.w3.org/ns/ttml":return"tt:"+b;case "https://web.archive.org/web/20200522155108/http://www.smpte-ra.org/schemas/2052-1/2010/smpte-tt":return"smpte:"+b;default:return""}},prune:function(a,b,c){var d=void 0;if(this.isInRegion(a,b)){d=this.translateMarkup(a,c);if(!d)return d;PlayerFramework.forEach(a.childNodes,PlayerFramework.proxy(this,function(a){a.nodeType!=this.nodeType.COMMENT_NODE&&(a.nodeType==this.nodeType.TEXT_NODE?d.appendChild(document.createTextNode(a.data)):(a=this.prune(a,b,c))&&d.appendChild(a))}))}return d},getLocalTagName:function(a){return a.localName?
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 26.611
  LoadShardBlock: 983.919 (3)
  PetaboxLoader3.datanode: 932.096 (5)
  PetaboxLoader3.resolve: 217.736 (3)
  load_resource: 276.696 (2)
*/